...
; Sprite OAM addresses.  Some may not be used.
...
currentWorld	EQU		_RAM_BLOCK_0+1			; Which world are we in.  0 for light, 1 for dark
...
; Adds one to the addres in hl if in dark world
WorldShift:
	ld 		a, [currentWorld]
	cp 		a, 0
	jr 		z, .DoneWorldShift
...
CopyMemory:
	ld		a, [hl]		; load data to be copied into a
